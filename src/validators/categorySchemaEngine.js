...
export const CATEGORY_SCHEMAS = {
  Flowers: {
    ...
    columns: [
      ...
      { key: "product_attributes.available_cities", label: "product_attributes.available_cities", mandatory: true,  type: "string",  example: "India",                                                  note: "Cities/countries where product is available. E.g. India" },
